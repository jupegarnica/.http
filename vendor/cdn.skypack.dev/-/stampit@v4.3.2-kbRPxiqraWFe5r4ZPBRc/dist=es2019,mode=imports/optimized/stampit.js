  ...
  !function() {
    ...
    var E = r.bind(0, function r2(t2, e2) {
      ...
      for (var n2, o2, i = S(e2), p = 0; p < i.length; )
        n2 = i[p++], (o2 = Object.getOwnPropertyDescriptor(e2, n2)).hasOwnProperty("value") ? o2.value !== u && (t2[n2] = r2(z(t2[n2]) || Array.isArray(e2[n2]) ? t2[n2] : {}, e2[n2])) : Object.defineProperty(t2, n2, o2);
      return t2;
    });
    function I() {
    ...
    function t(r2) {
      return c = function r3() {
        return function r4(t2) {
          var e2, n2, o2 = r4[D] || {}, i = {__proto__: o2[_]}, p = o2[v], c2 = Array.prototype.slice.apply(arguments), a2 = o2[l];
          if (a2 && E(i, a2), (a2 = o2[y]) && x(i, a2), (a2 = o2[b]) && Object.defineProperties(i, a2), !p || !p.length)
            return i;
          for (t2 === u && (t2 = {}), o2 = 0; o2 < p.length; )
            C(e2 = p[o2++]) && (i = (n2 = e2.call(i, t2, {instance: i, stamp: r4, args: c2})) === u ? i : n2);
          return i;
        };
    ...
    n[_] = o(_, x), n[y] = n.props = o(y, x), n[v] = n.init = o(v, I), n[w] = o(w, I), n[l] = n[P] = o(l, E), n[d] = n.statics = o(d, x), n[O] = n[A] = o(O, E), n[g] = n.conf = o(g, x), n[m] = n[j] = o(m, E), n[b] = o(b, x), n[h] = o(h, x), a = n[D] = x(function r2() {
    ...
    }, (s = {})[d] = n, f = R(s), a[D] = a.bind(), a.version = "4.3.2", module.exports = a;
  }();
});
