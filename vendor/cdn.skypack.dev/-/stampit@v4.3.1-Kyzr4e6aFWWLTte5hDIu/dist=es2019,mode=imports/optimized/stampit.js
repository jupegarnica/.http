  ...
  !function() {
    ...
    var B = i.bind(0, function t2(r2, n2) {
      ...
      for (var e2, o2, i2 = I(n2), u2 = 0; u2 < i2[S]; )
        e2 = i2[u2++], (o2 = N(n2, e2)).hasOwnProperty("value") ? o2.value !== f && (r2[e2] = t2(q(r2[e2]) || j(n2[e2]) ? r2[e2] : {}, n2[e2])) : C(r2, e2, o2);
      return r2;
    });
    function F() {
    ...
    function u(t2) {
      return p = function t3() {
        return function t4(r2) {
          var n2, e2, o2 = t4[D] || {}, i2 = {__proto__: o2[w]}, u2 = o2[O], p2 = E.apply(arguments), c2 = o2[l];
          if (c2 && B(i2, c2), (c2 = o2[s]) && R(i2, c2), (c2 = o2[y]) && x(i2, c2), !u2 || !u2[S])
            return i2;
          for (r2 === f && (r2 = {}), o2 = 0; o2 < u2[S]; )
            V(n2 = u2[o2++]) && (i2 = (e2 = n2.call(i2, r2, {instance: i2, stamp: t4, args: p2})) === f ? i2 : e2);
          return i2;
        };
      }(), (c = t2[m]) && B(p, c), (c = t2[d]) && R(p, c), (c = t2[v]) && x(p, c), c = V(p[D]) ? p[D] : H, R(p[D] = function() {
    ...
    function G(n2, e2) {
      ...
      return e2 && k(e2 = e2[D] || e2) && (t2(w), t2(s), t2(l, B), t2(y), t2(d), t2(m, B), t2(v), t2(h), t2(P, B), r2(O), r2(A)), n2;
    }
    function H() {
    ...
    function L(t2, r2) {
      return function() {
        return (a = {})[t2] = r2.apply(f, o.apply([{}], arguments)), ((p = this) && p[D] || c).call(p, a);
      };
    }
    K[w] = L(w, R), K[s] = K.props = L(s, R), K[O] = K.init = L(O, F), K[A] = L(A, F), K[l] = K[_] = L(l, B), K[d] = K.statics = L(d, R), K[m] = K[b] = L(m, B), K[h] = K.conf = L(h, R), K[P] = K[g] = L(P, B), K[y] = L(y, R), K[v] = L(v, R), c = K[D] = R(function t2() {
      for (var r2, n2, e2 = 0, o2 = [], i2 = arguments, u2 = this; e2 < i2[S]; )
        k(r2 = i2[e2++]) && o2.push(J(r2) ? r2 : ((a = {})[w] = (n2 = r2)[w] || f, c = n2.props, a[s] = k((p = n2[s]) || c) ? R({}, c, p) : f, a[O] = F(n2.init, n2[O]), a[A] = F(n2[A]), c = n2[_], a[l] = k((p = n2[l]) || c) ? B({}, c, p) : f, a[y] = n2[y], c = n2.statics, a[d] = k((p = n2[d]) || c) ? R({}, c, p) : f, c = n2[b], a[m] = k((p = n2[m]) || c) ? B({}, c, p) : f, p = n2[v], a[v] = k((c = n2.name && {name: {value: n2.name}}) || p) ? R({}, p, c) : f, c = n2.conf, a[h] = k((p = n2[h]) || c) ? R({}, c, p) : f, c = n2[g], a[P] = k((p = n2[P]) || c) ? B({}, c, p) : f, a));
    ...
    }, (a = {})[d] = K, z = H(a), c[D] = c.bind(), c.version = "4.3.1", module.exports = c;
  }();
});
...
export {stampit_min as __moduleExports, compose, composers, conf, configuration, deepConf, deepConfiguration, deepProperties, deepProps, deepStatics, init, initializers, methods, properties, propertyDescriptors, props, staticDeepProperties, staticProperties, staticPropertyDescriptors, statics, version};
