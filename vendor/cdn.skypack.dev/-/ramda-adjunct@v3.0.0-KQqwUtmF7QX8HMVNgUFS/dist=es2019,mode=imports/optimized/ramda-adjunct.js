import {always, equals as equals$1, complement, isNil, is, F, curryN, either, pipe, type as type$1, identical, anyPass, hasIn, both, isEmpty, allPass, has, toString, pathSatisfies, invoker, lt, gt, flip, lte as lte$1, gte, bind, converge, identity, modulo, length, values, ap as ap$2, curry, map as map$1, head, slice, reduce, reverse, propOr, partial, nth, tap, comparator, sort, prop, reduced, ifElse, compose, last, addIndex, apply, filter, includes, unapply, when, of as of$1, concat as concat$1, reduceRight, __, reject, append, insert, remove, uniq, uniqWith, all, nthArg, range, find, defaultTo, path, init, toPairs, over, lensIndex, fromPairs, props, mergeAll, lensPath, mergeLeft, useWith, pickBy, unary, pathOr, view, mergeRight, dissocPath, transpose, zip, empty as empty$1, traverse, propEq, pathEq, intersection, and, or, nAry, divide, subtract, replace, split, dropLastWhile, join, dropWhile} from "/-/ramda@v0.28.0-JBZigOn2cXGi5riTFQR8/dist=es2019,mode=imports/optimized/ramda.js";
...
var isIntegerPonyfill = both(_isFinite, converge(equals$1, [Math.floor, identity]));
...
var isOdd = curryN(1, both(isInteger, pipe(flip(modulo)(2), complement(equals$1)(0))));
...
var isPromise = curryN(1, both(isObj, pipe(toString, equals$1("[object Promise]"))));
...
var isFunctor = either(pathSatisfies(isFunction, ["map"]), pathSatisfies(isFunction, [map]));
var isApply = both(isFunctor, either(pathSatisfies(isFunction, ["ap"]), pathSatisfies(isFunction, [ap])));
...
var noneP = curryN(1, pipe(map$1(resolveP), map$1(function(p) {
...
var concatAll = pipe(reduce(concat$1, leftIdentitySemigroup), when(identical(leftIdentitySemigroup), stubUndefined));
...
var unzipObjWith = curryN(2, function(fn, obj) {
  return pipe(toPairs, map$1(pipe(flip, apply)(fn)), transpose, when(lengthEq(0), function() {
    return [[], []];
  }))(obj);
});
...
export {Identity, Y, allEqual, allEqualTo, allIdentical, allIdenticalTo, allP, allSettledP, allUnique, anyP, appendFlipped, argsPass, async, catamorphism as cata, catchP, ceil, compact, concatAll, concatRight, copyKeys, curryRight, curryRightN, defaultWhen, delayP, dispatch, divideNum, dropArgs, ensureArray, escapeRegExp, filterIndexed, findOr, anyP as firstP, flattenDepth, flattenPath, flattenProp, floor, fnull, inRange, included, invoke, invokeArgs, isArray, isArrayLike, isAsyncFunction, isBigInt, isBoolean, isDate, isEmptyArray, isEmptyString, isError, isEven, isFalse, isFalsy, _isFinite as isFinite, isFloat, isFunction, isGeneratorFunction, isIndexed, isInteger32 as isInt32, isInteger, isInteger32, isNotValidDate as isInvalidDate, isIterable, isMap, _isNaN as isNaN, isNaturalNumber, isNegative, isNegativeZero, isNilOrEmpty, isNonEmptyArray, isNonEmptyString, isNonNegative, isNonPositive, isNotArray, isNotArrayLike, isNotAsyncFunction, isNotBoolean, isNotDate, isNotEmpty, isNotFinite, isNotFloat, isNotFunction, isNotGeneratorFunction, isNotInteger, isNotMap, isNotNaN, isNotNil, isNotNilOrEmpty, isNotNull, isNotNumber, isNotObj, isNotObjLike, isNotObj as isNotObject, isNotObjLike as isNotObjectLike, isNotPair, isNotPlainObj, isNotPlainObj as isNotPlainObject, isNotPrimitive, isNotRegExp, isNotSet, isNotString, isNotUndefined, isNotValidDate, isNotValidNumber, isNull, isNumber, isObj, isObjLike, isObj as isObject, isObjLike as isObjectLike, isOdd, isPair, isPlainObj, isPlainObj as isPlainObject, isPositive, isPositiveZero, isPrimitive, isPromise, isPrototypeOf, isRegExp, isSafeInteger, isSentinelValue, isSet, isSparseArray, isString, isSymbol, isThenable, isTrue, isTruthy, isUndefined, isValidDate, isValidNumber, lastP, lengthEq, lengthGt, lengthGte, lengthLt, lengthLte, lengthNotEq, lensEq, lensIso, lensNotEq, lensNotSatisfy, lensSatisfies, lensTraverse, liftF, liftFN, list, mapIndexed, mergePath, mergePaths, mergeProp, mergeProps, move, nand, neither, noneP, nonePass, noop, nor, notAllPass, notAllUnique, notBoth, notEqual, omitBy, omitIndexes, overlaps, padCharsEnd, padCharsStart, padEnd, padStart, pathNotEq, pathOrLazy, paths, pickIndexes, propNotEq, rangeStep, reduceIndexed, reduceP, reduceRightP, rejectP, renameKeyWith, renameKeys, renameKeysWith, repeatStr, replaceAll$1 as replaceAll, resolveP, round, seq, seq as sequencing, sign, skipTake, sliceFrom, sliceTo, sortByProps, spreadPath, spreadProp, stubArray, stubNull, stubObj, stubObj as stubObject, stubString, stubUndefined, subtractNum, thenCatchP, toArray, toInteger32 as toInt32, toInteger32, toNumber, toUinteger32 as toUint32, toUinteger32, trimCharsEnd, trimCharsStart, trimEnd, trimStart$1 as trimLeft, trimEnd as trimRight, trimStart$1 as trimStart, trunc, unzipObjWith, viewOr, weave, weaveLazy, zipObjWith};
export default null;
