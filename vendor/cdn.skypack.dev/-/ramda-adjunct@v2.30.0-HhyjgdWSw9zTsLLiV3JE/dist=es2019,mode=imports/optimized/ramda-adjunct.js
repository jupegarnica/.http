import {
  ...
  when,
  zip,
} from "/-/ramda@v0.27.1-3ePaNsppsnXYRcaNcaWn/dist=es2019,mode=imports/optimized/ramda.js";
...
var isFunctor = either(
  ...
  pathSatisfies(isFunction, [mapping.map]),
);
var isApply = both(
  isFunctor,
  either(
    pathSatisfies(isFunction, ["ap"]),
    pathSatisfies(isFunction, [mapping.ap]),
  ),
);
...
var ordTrait = _defineProperty({}, mapping.lte, function (ord) {
  return isSameType(this, ord) &&
    (this.value < ord.value || this[mapping.equals](ord));
});
...
var of = mapping.of,
  _ap = mapping.ap,
  _map = mapping.map,
  _equals = mapping.equals,
  _concat = mapping.concat,
  _chain = mapping.chain,
  _lte = mapping.lte,
  _empty = mapping.empty,
  _contramap = mapping.contramap;
...
export {
  ...
  mergeProps,
  mergeRight,
  mergeRight as mergeLeft,
  mergeRight as resetToDefault,
  move,
  nand,
  neither,
  noneP,
