...
var require$$1 = /* @__PURE__ */ getDefaultExportFromNamespaceIfNotNamed(ramdaAdjunct);
...
const hierPart$1 = ([authorityNode, absolutePathNode], location) => cst.HierPart({
  location,
  ...
  (function() {
    ...
    var grammar2 = {
      ...
      ParserRules: [
        ...
        {name: "MESSAGE_BODY", symbols: ["MESSAGES"], postprocess: messageBody2},
...
export {src as __moduleExports, parse$2 as parse};
